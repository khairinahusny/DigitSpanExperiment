    ...
    function show_current_page() {
      if (trial.show_clickable_nav) {
        ...
        if (trial.pages.length == 1) {
          nav_html += "<button id='jspsych-instructions-next'>Arahan tamat</button>"
        } else {
          if (current_page == 0) {
            nav_html += "<button id='jspsych-instructions-next'>Seterusnya</button>"
          } else if (current_page == trial.pages.length - 1) {
            if (trial.allow_backward) {
              nav_html += "<button id='jspsych-instructions-back'>Sebelumnya</button>";
            }
            nav_html += "<button id='jspsych-instructions-next'>Arahan tamat</button>"
          } else {
            if (trial.allow_backward) {
