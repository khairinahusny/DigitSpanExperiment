  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>Eksperimen akan dijalankan dalam mod skrin penuh. Tekan butang di bawah.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Mulakan eksperimen</button></div>');
